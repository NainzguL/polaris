...
var Transfer = (function ($) {
    ...
    function generateTransfer(inputId, currentTimeStr) {
        var htmlStr =
            ...
            + '<div class="btn-select-arrow" id="add_selected_' + currentTimeStr + '"><i class="fa fa-chevron-right"></i></div>'
            + '<div class="btn-select-arrow" id="delete_selected_' + currentTimeStr + '"><i class="fa fa-chevron-left"></i></div>'
            + '</div>'
