...
var career = {
	...
	"priest": {
		"id": "priest",
		"condition": [],
		"competence": ["defensiveMartialArts", "armedStruggle",
			"psychology", "leadership", "eloquence",
			"mentalShield", "bodyControl", "controlPolarisEcho", "controlPolarisEffect", "polarisPower1", "polarisPower2", "polarisPower3", "Meditation",
			"natTridentWorship", "education", 
			"knowCity", "observation", "firstAid"],
		"bitchyCompetence": ["natOriginNation"],
		"competenceChoice": [{"number": 1, 
		                      "competence": ["natOriginNation", "natEquinoxe", ]},
		                     {"number": 3, 
		                      "competence": ["knowAdministration", "knowBiology", "knowEconomic", "knowGeography", "knowHistory", "knowLaw", "knowMedicine", "knowPsychology", "knowPoliticalScience", "knowSociology"]},
		                      {"number": 2, 
		                      "competence": ["natHegemonie", "natRedLeague", "natCoralRepublic", "natEquinoxe", "natMediterraneanUnion", "natPolarAlliance", "natAmazonia", "natRiftState", "natEnderby", "natCapFederation", "natFuegoLibertad", "natLemurie", "natRodhia", "natIndus", "natWatchmen", "natMercenary", "natMilitary", "natPirate", "natSmuggler", "natScavenger", "natCriminality", "natTridentWorship", "natBlackSun", "natAbysseBrother", "natLeviathan", "natThemis", "natGeneticist", "natAllianceAzure",
		                      	             "tradeInformation", "tradeBlack", "seeking",
		                      	             "aggressiveMartialArts", "unarmedStruggle"]},],
		"progression": [
			[0, 2, 100],
			[3, 8, 500],
			[9, 12, 2000],
		...
		"rival": 0.25, 
		"enemies": 0.,
		"businessAdvantage": ["relationship", "equipment", "privateCabin", "fame"],
		"obtainableEquipmentGroup": ["standardEquipment", "contactWeapon", "computerEquipment",],
		"randomBusinessAdvantage": [],
	},
	"scholar": {
		"id": "scholar",
